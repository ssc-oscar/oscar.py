...
build_manylinux:
	docker run --rm -e PLAT=manylinux2010_x86_64 -v `pwd`:/github/workspace/ manylinux2010_x86_64 "cp27-cp27m cp36-cp36m" "cython setuptools>=18.0" "bzip2-devel zlib-devel"
